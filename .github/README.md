...
[`@aws-sdk/client-transcribe`](https://www.npmjs.com/package/@aws-sdk/client-transcribe/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bpMi+UpNFzigPEavBxInlcxmDFNML5fLjW5NLhYmD66HF6tb0cDtoc0OgjwBMn5/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-transcribe": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.908.0/index.min.mjs": "sha384-bpMi+UpNFzigPEavBxInlcxmDFNML5fLjW5NLhYmD66HF6tb0cDtoc0OgjwBMn5/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-transcribe/blob/refs/tags/3.908.0/LICENSE
```
