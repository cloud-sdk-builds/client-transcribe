...
[`@aws-sdk/client-transcribe`](https://www.npmjs.com/package/@aws-sdk/client-transcribe/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t0ki+WPpCZc3PLxWLw6vhoa+1xs39p3/nG2pQQatCSB78fAkkGux3iONpdy8SY/a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-transcribe": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.35.0/index.min.mjs": "sha384-t0ki+WPpCZc3PLxWLw6vhoa+1xs39p3/nG2pQQatCSB78fAkkGux3iONpdy8SY/a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-transcribe/blob/refs/tags/3.35.0/LICENSE
```
