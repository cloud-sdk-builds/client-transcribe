...
[`@aws-sdk/client-transcribe`](https://www.npmjs.com/package/@aws-sdk/client-transcribe/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QKRA2XtMzLC+Bh7CYg9MItSAde84AcHhPWshOZVMEtAtBnReRN8sN3qceaFH19p9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-transcribe": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe@3.876.0/index.min.mjs": "sha384-QKRA2XtMzLC+Bh7CYg9MItSAde84AcHhPWshOZVMEtAtBnReRN8sN3qceaFH19p9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-transcribe/blob/refs/tags/3.876.0/LICENSE
```
